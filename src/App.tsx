...
In 3–4 sentences: what you took from each model and why. Name specific lines or angles.`,
  ...
  return (
    <div style={{ position:"fixed", inset:0, background:"rgba(13,15,26,0.45)", zIndex:200,
      display:"flex", alignItems:"flex-start", justifyContent:"center",
      padding:"20px 16px", overflowY:"auto", backdropFilter:"blur(4px)" }}>
      <div style={{ width:"100%", maxWidth:980, background:C.canvas, borderRadius:14,
        ...
        <div style={{ display:"flex", minHeight:580 }}>
          {/* Left nav */}
          <div style={{ width:160, background:C.surface, borderRight:`1px solid ${C.border}`, flexShrink:0, padding:"10px 0" }}>
            {panel==="form" && (
              <>
          ...
          {/* Main content */}
          <div style={{ flex:1, padding:"24px 28px", overflowY:"auto", maxHeight:"74vh" }}>
            {panel==="form" && (
        ...
        <div style={{ display:"flex", alignItems:"center", gap:12, padding:"14px 22px",
          borderTop:`1px solid ${C.border}`, background:C.surface, borderRadius:"0 0 13px 13px" }}>
          <span style={{ fontSize:10, color:C.muted, fontFamily:mono }}>{totFill}/{TOTAL_FIELDS} filled</span>
          <div style={{ flex:1 }}><ProgressBar pct={Math.round(totFill/TOTAL_FIELDS*100)} color={icp.color} height={2} /></div>
          <button onClick={generateAll} disabled={genState==="running"||!data.industries} style={{
            ...
            boxShadow:data.industries&&genState!=="running"?`0 2px 12px ${C.accent}40`:"none",
            transition:"all .15s" }}>
            {genState==="running" ? "Generating…" : icp.outputs ? "Regenerate Outputs" : "Generate All Outputs →"}
          </button>
        </div>
      </div>
    </div>
